...
test("reference hub pages", () => {
  ...
  expect(typesPage.body).toContain("```drac");
    ...
    expect(typesPage.body).toContain("## Object types");
    expect(typesPage.body).toContain("## Unions and intersections");
    expect(typesPage.body).toContain("## Generics");
    expect(typesPage.body).toContain("## Native types");
    expect(typesPage.body).toContain("## i8, u8, f32, and bool");
    expect(typesPage.body).toContain("let tiny: i8");
    expect(typesPage.body).toContain("let byte: u8");
    expect(typesPage.body).toContain("let single: f32");
    expect(typesPage.body).toContain("let flag: bool");
    expect(typesPage.body).toContain("## Fixed structs");
    expect(typesPage.body).toContain("## Fixed arrays");
    expect(typesPage.body).toContain("type Vec3 = [i32, i32, i32]");
    expect(typesPage.body).toContain("## Pointers");
    expect(typesPage.body).toContain("let p: *i32 = &x");
    expect(typesPage.body).toContain("## Crossing");
    expect(typesPage.body).toContain("type User = { name: string; id: number }");
    ...
    expect(types).toContain("StrOrNum");
  ...
  expect(hostIoPage.body).toContain("draconic check");
    ...
    expect(hostIoPage.body).toContain("`pathDirname(path)`");
    expect(hostIoPage.body).toContain("`pathBasename(path)`");
    expect(hostIoPage.body).toContain("`pathExtname(path)`");
    expect(hostIoPage.body).toContain("`pathIsAbsolute(path)`");
    expect(hostIoPage.body).toContain("`pathResolve(...)`");
    expect(hostIoPage.body).toContain("## exists");
    expect(hostIoPage.body).toContain("`exists(path)`");
    expect(hostIoPage.body).toContain("## mkdir");
    expect(hostIoPage.body).toContain("`mkdir(path)`");
    expect(hostIoPage.body).toContain("`mkdirAll(path)`");
    expect(hostIoPage.body).toContain("`readdir(path)`");
    expect(hostIoPage.body).toContain("`rmdir(path)`");
    expect(hostIoPage.body).toContain("`removeFile(path)`");
